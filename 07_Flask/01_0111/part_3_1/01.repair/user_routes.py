...
#                        (user_data['name'], user_data['email'], user_id))        # user_data쪽의 괄호는 뒤의 코드는 변수임을 확인하기 쉽게 해주는 것이다.
#         mysql.connection.commit()
#         cursor.close()
...
#     # 유저를 삭제하는 함수 (DELETE)
#     @user_blp.route('/<int:ser_id', methods=['DELETE'])
#     def delete_user(user_id):
#         cursor = mysql.connection.cursor()
#         cursor.exectue("DELETE FROM users WHERE id = %s", (user_id, ))
#         mysql.connection.commit()
#         cursor.close()
